...
void execute(const speak_out_loud::SpeakGoalConstPtr& goal, Server* as, string lang, string default_voice) 
{
...
int main(int argc, char** argv)
{
  ...
  Server server(n, "speak_out_loud", boost::bind(&execute, _1, &server, lang, default_voice), false);
  server.start();
  ros::spin();
  return 0;
}
