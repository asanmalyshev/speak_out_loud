...
class Speaker(object) :
    ...
    def __init__(self):
        ...
        rospy.Subscriber("/speak_out_loud_texts", SpeakGoal, self.speak_out_cb)
        rospy.Subscriber("/speak_out_loud_texts_debug", SpeakGoal, self.speak_out_debug_cb)
        rospy.Subscriber("/speak_out_loud_whitelist", String, self.whitelist_upd_cb)
        rospy.Subscriber("/speak_out_loud_blacklist", String, self.blacklist_upd_cb)
        rospy.Subscriber("/speak_out_loud_whitelist_on", Bool, self.whitelist_on_cb)
        rospy.Subscriber("/speak_out_loud_blacklist_on", Bool, self.blacklist_on_cb)
